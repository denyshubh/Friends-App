...
class FirestoreClient {
    ...
    constructor(opts) {
        ...
        var protos = merge({}, gaxGrpc.loadProto(path.join(__dirname, '..', '..', 'protos'), 'google/firestore/v1beta1/firestore.proto'));
        ...
        var defaults = gaxGrpc.constructSettings('google.firestore.v1beta1.Firestore', gapicConfig, opts.clientConfig, { 'x-goog-api-client': clientHeader.join(' ') });
        ...
        var firestoreStub = gaxGrpc.createStub(protos.google.firestore.v1beta1.Firestore, opts);
